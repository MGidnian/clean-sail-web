...
export const DownloadButtons = () => {
  ...
  const handleAppStoreClick = () => {
    // Open App Store link
    window.open('https://apps.apple.com/il/app/fisherman-sms-filtering/id6449192504?utm_source=website&utm_medium=download_section&utm_campaign=download_button', '_blank');
