...
export const Hero = () => {
  ...
  const handleAppStoreClick = () => {
    // Open App Store link
    window.open('https://apps.apple.com/il/app/fisherman-sms-filtering/id6449192504?utm_source=website&utm_medium=hero_section&utm_campaign=top_button', '_blank');
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 mb-8 md:mb-0 text-center md:text-start">
            ...
            <div className="flex flex-col sm:flex-row justify-center sm:justify-center md:justify-start gap-4">
              {/* App Store Button */}
