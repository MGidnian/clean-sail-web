      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-fisherman-gray rounded-xl p-6 transition-all duration-300 hover:shadow-lg text-center">
            ...
            <h3 className="text-xl font-semibold mb-2">{t('values.privacy')}</h3>
            <p className="text-gray-600">{t('values.privacy.desc')}</p>
          </div>
          
          {/* Value 2: Community Reporting */}
          <div className="bg-fisherman-gray rounded-xl p-6 transition-all duration-300 hover:shadow-lg text-center">
            <div className="flex justify-center mb-4">
              <MessageSquare className="h-12 w-12 text-fisherman-blue" />
            </div>
            <h3 className="text-xl font-semibold mb-2">{t('values.together')}</h3>
            <p className="text-gray-600">{t('values.together.desc')}</p>
          </div>
